...
public class VerificaDataJava8 extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VerificaDataJava8 frame = new VerificaDataJava8();
	...
	public VerificaDataJava8() {
		setTitle("Verifica Data - Java 8");
...
//				.withResolverStyle(ResolverStyle.STRICT);
		...
		DateTimeFormatter df = SwUtil.getDateTimeFormatter();
